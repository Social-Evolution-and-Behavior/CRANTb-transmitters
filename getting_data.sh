...
export CLOUDFILES_DIR="/ru-auth/local/home/jlee11/scratch/nt_predictions/.cloudfiles"
...
STRIDE=1000
START_IDX=$((SLURM_ARRAY_TASK_ID * STRIDE))
END_IDX=$((START_IDX + STRIDE))

echo "Processing synapses from index $START_IDX to $END_IDX"


CACHE_DIR="/ru-auth/local/home/jlee11/scratch/nt_predictions/$(date '+%Y%m%d')_caches"

python -u /ru-auth/local/home/jlee11/scratch/nt_predictions/CRANTb-transmitters_repo/getting_data.py \
    --start-index $START_IDX \
    --end-index $END_IDX \
    --locations-file /lustre/fs4/kron_lab/scratch/jlee11/nt_predictions/250721_pseudoGT_neurotransmitter_noduplicates.feather \
